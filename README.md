...
8.  [why modeling](./notes/08-why-modeling)
9.  [requirements engineering](./notes/09-requirements-engineering)
10. [case modeling](./notes/10-case-modeling)
11. [uml class diagrams](./notes/11-uml-class-diagrams)
...
4.  [matrix operations](./src/lab04/)
5.  [uml use case modeling](./src/lab05/)
6.  [uml class diagram](./src/lab06/)
7.  [web programming in html, css, js, php](./src/lab07/)
8.  [databases with sql programming](./src/lab08/)
9.  [container programming using docker](./src/lab09/)
10. [software testing](./src/lab10/)
11. [matching](./src/matching/)
